...
Out of the two main models trained, in bfloat16 and float32 precision, this application uses the bfloat16 variant. For using the float32 variant, please refer the notebook link towards the end of this README file. 
...
This notebook listed above is used for inference on Kaggle. 
